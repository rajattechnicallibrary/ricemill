...
if(!function_exists('custompaging'))
{
    function custompaging($cur_page,$no_of_paginations,$previous_btn,$next_btn,$first_btn,$last_btn)
    {
        ...
        $msg .= "<div class='text-right'style='margin-right:15px;'><div class='dataTables_paginate paging_simple_numbers'>
                    ...
                    {
                        $pre = $cur_page - 1;
                        $msg .= "<li p='$pre' class='paginate_button previous '><a href='#'><i class='material-icons'>chevron_left</i></a></li>";
                    }
                    else if ($previous_btn)
                    {
                        $msg .= "<li class='paginate_button  disabled'><a href='#'><i class='material-icons'>chevron_left</i></a></li>";
                    }
                    ...
                    {
                        $nex = $cur_page + 1;
                        $msg .= "<li p='$nex' class='paginate_button next '><a href='#'><i class='material-icons'>chevron_right</i></a></li>";
                    }
                    else if ($next_btn)
                    {
                        $msg .= "<li class='paginate_button disabled '><a href='#'><i class='material-icons'>chevron_right</i></a></li>";
                    }
