                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <?php  $name = @$result->name;
                                                    $postvalue = @$_POST['state_name'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('name' => 'state_name','maxlength'=>'25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'State Name', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                                 ?>
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c text-center">
                                                   ...
                                                   <a href="<?php echo base_url('master/state/');?>"><button type="button" class="btn btn-primary"> Cancel </button></a>
