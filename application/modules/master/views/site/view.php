                            ...
                            <div class="col-md-12">
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    ...
                                    <thead>
                                            ...
                                            <tr>
                                                <td class="table_bg" scope="col">Site Account No</td>
                                                <td scope="col"><?php echo $result->site_account_no;?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="table_bg" scope="col">Site Address</td>
                                                <td scope="col"><?php echo $result->site_address;?></td>
                                            </tr>
                                            <tr>
                                                <td class="table_bg" scope="col">Site Gst No</td>
                                                <td scope="col"><?php echo $result->site_gst_no;?></td>
                                            </tr>
                                            <tr>
