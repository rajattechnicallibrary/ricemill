                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?=get_flashdata();?>
									...
									<a href="<?php echo base_url('master/site/add');?>" id="back-btn" class="btn cur-p btn-primary pull-right">ADD</a>
...
<script>
        ...
        if(id !=''){
            ...
            jConfirm('Are you sure?', 'Confirmation Dialog', function(r) {
                if(r)
                {
                    $.ajax({
                        type:"POST",
                        url:"<?php echo site_url("master/site/delete_city") ?>",
    ...
    table.dataTable({
        ...
        "ajax": {
            url: "<?php echo base_url(); ?>/master/site/view_all?<?php echo $QUERY_STRING; ?>", // json datasource
            type: "post",
