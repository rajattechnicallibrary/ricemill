...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('name' => 'site_name','maxlength'=>'25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Site Name', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                            ?>
...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                           ...
                                           <div class="form-group col-md-6">
                                               <label for="inputState2">Site Account No. *</label>
                                               <?php  $name = @$result->site_account_no;
                                               $postvalue = @$_POST['site_account_no'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('type' =>'number' , 'name' => 'site_account_no','maxlength'=>'25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Site Account Number', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                            ?>
                                              <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('site_account_no'); ?></div></label>
...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                       ...
                                       <div class="form-row">
                                           ...
                                           <div class="form-group col-md-6">
                                               <label for="inputEmail4">Site Address *</label>
                                              <?php  $name = @$result->site_address;
                                               $postvalue = @$_POST['site_address'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('name' => 'site_address','maxlength'=>'25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Site Address', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                            ?>
                                              <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('site_address'); ?></div></label>
                                           </div>
                                           <div class="form-group col-md-6">
                                               <label for="inputState2">Site GST No. *</label>
                                               <?php  $name = @$result->site_gst_no;
                                               $postvalue = @$_POST['site_gst_no'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('name' => 'site_gst_no','maxlength'=>'25', 'class' => 'form-control', 'id' => 'cate_id', 'placeholder' => 'Site GST No.', 'value' => !empty($postvalue) ? $postvalue : $name ,'onkeyup'=>'validate_character(this)'));
                                            ?>
                                              <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('site_gst_no'); ?></div></label>
...
$('#ciatyform_id').validate({
    ...
    messages:{
        site_name:{
         required:'<div style="color:red">Site Name field is required.</div>',        
        },
        city_name:{
