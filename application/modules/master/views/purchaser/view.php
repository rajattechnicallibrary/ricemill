                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    ...
                                    <a href="<?=base_url()?>master/purchaser/" id="back-btn" class="btn cur-p btn-primary pull-right">Back</a>
                                    <br><br>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="table_bg" scope="col">Purchaser Account No</td>
                                                <td scope="col"><?php echo $result->purchaser_account_no;?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="table_bg" scope="col">Purchaser Address</td>
                                                <td scope="col"><?php echo $result->purchaser_address;?></td>
                                            </tr>
                                            <tr>
                                                <td class="table_bg" scope="col">Purchaser Gst No</td>
                                                <td scope="col"><?php echo $result->purchaser_gst_no;?></td>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td  class="table_bg" scope="row">Status</td>
