...
class Quality_mod extends CI_Model {
...
//THIS FUNCTION ADD COLOR1
    public function add($data) {               
        if ($this->db->insert("aa_quality", $data)) {
            return true;
        }
    }
...
//  THIS FUNCTION DELETE city DATA
    function delete_city($id) {
        ...
        $this->db->update('aa_quality', $data);
        return true;
    }
...
//  THIS FUNCTION VIEW city DATA
    function view($id) {
        $this->db->select('*');
        $this->db->where('quality_id', $id);
        return $query = $this->db->get("aa_quality")->row();
    }
    ...
    function count_city_data() {
        ...
        return $query = $this->db->get('aa_quality');
    }
    ...
    function get_city_data($parent_id = "") {        
        ...
        $this->db->from('aa_quality as wct');
         $this->db->join('aa_quality wcntry','wct.quality_id=wcntry.quality_id','left');
