                ...
                <div id="mainContent">
                    ...
                    <table class="table table-striped table-bordered"  id="employee-grid-buyer">
                        <thead>
                            ...
                            <th>Service Charge( Advertiser ) &#163;</th>
                            <th>Service Charge( Publisher ) %</th>
                            <th>Status</th>                            
                            <th>Action</th>
                            </tr>
...
<script>
    ...
    table.dataTable({
        ...
        "ajax": {
            url: "<?php echo base_url(); ?>admin/service_charge/view_all?<?php echo $QUERY_STRING; ?>", // json datasource
            type: "post",
