                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?=get_flashdata();?>
									...
									<a href="<?php echo base_url('admin/billing/add');?>" id="back-btn" class="btn cur-p btn-primary pull-right">ADD</a>
...
<script>
    ...
    table.dataTable({
        ...
        "ajax": {
            url: "<?php echo base_url(); ?>admin/billing/view_all?<?php echo $QUERY_STRING; ?>", // json datasource
            type: "post",
