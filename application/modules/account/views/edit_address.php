				...
				<div class="account-right-section">
					 <div class="" id="">		
						...
						<div class="account-detail-form">
						  <form action="<?php echo base_url();?>account/edit_address?id=<?=ID_encode(@$user_address->id)?>" method="post" id="edit_address">
							...
							<div class="add-recipe-grid-1">
							  <div class="form-group">
								<label for="">Address <span class="required" aria-required="true" style="color:#e02222">
									* </span></label>
								<input type="text" name="address" value="<?php echo set_value('address',$user_address->address)?>" class="form-control" id="" placeholder="" maxlength="100"/>
							...
							<div class="add-recipe-grid-1">
							  <div class="form-group">
								<label for="">Zipcode <span class="required" aria-required="true" style="color:#e02222">
									* </span></label>
								<input type="text" name="zipcode" value="<?php echo set_value('zipcode',$user_address->zipcode)?>" class="form-control numbersOnly" id="" placeholder="" maxlength="6"/>
							...
							<div class="add-recipe-grid-1">
							  <div class="form-group">
								<label for="">Landmark <span class="required" aria-required="true" style="color:#e02222">
									* </span></label>
								<input type="text" name="landmark" value="<?php echo set_value('landmark',$user_address->landmark)?>" class="form-control" id="" placeholder="" maxlength="35"/>
							...
							<div class="add-recipe-grid-1">
							  <div class="form-group">
								<label for="">Delivery Instructions<span class="required" aria-required="true" style="color:#e02222">
									* </span> </label>
								<input type="text" name="delivery_instruction" value="<?php echo set_value('delivery_instruction',$user_address->delivery_instruction)?>" class="form-control" id="" placeholder="" maxlength="100"/>
							 ...
							 <div class="row">
								 <div class="col-md-12">
									...
									* </span></label>    
									...
									<?php $location = $user_address->location;
                                       ?>
										<input type="text" name="location" value="<?=(@$_POST['location'])?@$_POST['location']: $location?>" placeholder="" id="pac-input" class="form-control" required />
